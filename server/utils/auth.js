...
module.exports = {
  ...
  authMiddleware: function ({ req }) {
    ...
    //ABOVE-if secret on jwt.verify() doesn't match the secret that was used with jwt.sign(), the object won't be decoded. When the JWT verification fails, an error is thrown.
